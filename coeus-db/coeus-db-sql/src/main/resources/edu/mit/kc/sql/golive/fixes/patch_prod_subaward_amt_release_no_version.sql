...
SELECT SUBAWARD_CODE,SEQUENCE_NUMBER,document_number FROM SUBAWARD ORDER BY SUBAWARD_CODE,SEQUENCE_NUMBER;
	...
	li_mit_seq:=r_subaward.SEQUENCE_NUMBER;
			...
			EXIT WHEN c_amt%NOTFOUND;
				...
				BEGIN
					...
					VALUES(li_amt_released,li_subaward_id,r_amt.AMOUNT_RELEASED,r_amt.EFFECTIVE_DATE,r_amt.COMMENTS,r_amt.UPDATE_TIMESTAMP,r_amt.UPDATE_USER,r_amt.INVOICE_NUMBER,r_amt.START_DATE,r_amt.END_DATE,r_amt.STATUS_CODE,r_amt.APPROVAL_COMMENTS,r_amt.APPROVED_BY_USER,r_amt.APPROVAL_DATE,r_amt.DOCUMENT,r_amt.FILE_NAME,ls_create_id,r_amt.CREATED_DATE,null,li_ver_nbr, SYS_GUID(),li_seq,ls_subaward_code,r_subaward.document_number,null);
