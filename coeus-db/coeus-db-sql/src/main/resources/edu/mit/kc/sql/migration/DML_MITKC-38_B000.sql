...
VALUES((select max(REPORT_CODE) + 1 from REPORT),1,'Non-competing Continuation','N',SYSDATE,'admin', SYS_GUID(),'Y');
commit;
INSERT INTO REPORT(REPORT_CODE,VER_NBR,DESCRIPTION,FINAL_REPORT_FLAG,UPDATE_TIMESTAMP,UPDATE_USER,OBJ_ID,ACTIVE_FLAG)
VALUES((select max(REPORT_CODE) + 1 from REPORT),1,'Competing Renewal','N',SYSDATE,'admin', SYS_GUID(),'Y');
commit;
