INSERT INTO PROPOSAL_ATTACHMENT_TYPE(
...
1,
SYS_GUID()
FROM OSP$PROPOSAL_ATTACHMENT_TYPE@coeus.kuali
/
commit
/
create table osp$proposal_attachments as select * from osp$proposal_attachments@coeus.kuali
/
declare
...
begin
 ...
 li_loop_count := 0;
   ...
   exit when c_prop_att%notfound;
    ...
    r_prop_att.document_status_code,
    li_prp_att_data_id  
    );
