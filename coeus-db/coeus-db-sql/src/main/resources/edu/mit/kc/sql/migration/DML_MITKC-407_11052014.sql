UPDATE SUBAWARD_ATTACHMENTS
SET SUBAWARD_CODE=to_number(SUBAWARD_CODE);
commit
/
...
/
DELETE FROM ATTACHMENT_FILE WHERE FILE_NAME IN(SELECT FILE_NAME FROM SUBAWARD_AMOUNT_INFO)
/
