...
cursor c_protocol_submission is
	...
	where pa.proto_amend_ren_number in ('0906003331R005','1005003876R004','1205005043R002')
...
exit when c_protocol_submission%notfound;
	...
	begin
	 ...
	 select min(submission_id) into li_submission_id from protocol_submission 
