...
begin
  ...
  if li_count = 0 then
            ...
            ');
            Insert into TEMP_LOOKUP_CFG_PARM (DOC_TYP_NM,NM,KEY_CD,VAL) values ('ProposalDevelopmentDocument','isHierarchyChild','type','org.kuali.kra.kew.SimpleBooleanSplitNode');
  ...
  if li_count = 0 then
        ...
        Insert into TEMP_LOOKUP_RTE_NODE (DOC_TYP_NM,NM,TYP,PROTO_BRCH_NM,RTE_MTHD_NM,RTE_MTHD_CD,ACTVN_TYP,SORT_ID) values ('ProposalDevelopmentDocument','isHierarchyChild','org.kuali.kra.kew.SimpleBooleanSplitNode','null',null,null,'S',2);
