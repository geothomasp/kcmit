select ' Start time of award_sequence_status_update is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of award_sequence_status_update is '|| localtimestamp from dual
/        
