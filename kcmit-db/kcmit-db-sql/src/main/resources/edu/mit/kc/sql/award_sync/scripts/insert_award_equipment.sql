select ' Start time of AWARD_APPROVED_EQUIPMENT  script is '|| localtimestamp from dual
/
DECLARE
...
END;
/	
select ' End time of AWARD_APPROVED_EQUIPMENT  script is '|| localtimestamp from dual
/