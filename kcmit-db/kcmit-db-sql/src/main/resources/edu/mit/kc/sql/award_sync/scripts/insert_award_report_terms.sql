 ...
 select SEQUENCE_AWARD_ID.NEXTVAL into li_award_reports_id from dual;
    ...
    IF r_award_comment.MIT_AWARD_NUMBER IS NULL THEN
	     ...
	     IF ls_award_number is null THEN
	         ...
	         SELECT li_award_reports_id,r_award_comment.AWARD_ID,r_award_comment.AWARD_NUMBER,r_award_comment.Kuali_sequence_number,REPORT_CLASS_CODE,REPORT_CODE,FREQUENCY_CODE,FREQUENCY_BASE_CODE,OSP_DISTRIBUTION_CODE,DUE_DATE,1,UPDATE_TIMESTAMP,UPDATE_USER,SYS_GUID() FROM AWARD_REPORT_TERMS
           ...
           WHERE AWARD_REPORT_TERMS_ID=(SELECT AWARD_REPORT_TERMS_ID FROM AWARD_REPORT_TERMS WHERE AWARD_NUMBER=r_award_comment.AWARD_NUMBER and 	SEQUENCE_NUMBER=(SELECT MAX(aw.SEQUENCE_NUMBER) FROM AWARD_REPORT_TERMS aw where aw.AWARD_NUMBER=r_award_comment.AWARD_NUMBER AND aw.SEQUENCE_NUMBER<r_award_comment.Kuali_sequence_number)); 
