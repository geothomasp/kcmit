select ' Start time of  Insert to PROPOSAL is '|| localtimestamp from dual
/
declare
li_count number;
begin
...
/ 
select ' End time of PROPOSAL KREW TABLES  is '|| localtimestamp from dual
/
---------- KREW ENDS ----------------------------------
select ' End time of  Insert to PROPOSAL is '|| localtimestamp from dual
/