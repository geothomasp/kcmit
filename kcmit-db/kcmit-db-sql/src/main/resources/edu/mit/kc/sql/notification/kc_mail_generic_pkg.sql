create or replace PACKAGE KC_MAIL_GENERIC_PKG is              
 ...
 PROCEDURE GET_NOTIFICATION_TYP_DETS(AV_NOTIFICATION_TYPE_ID IN NOTIFICATION_TYPE.NOTIFICATION_TYPE_ID%TYPE , 
 ...
 PROCEDURE	SEND_MAIL( AV_RECIPIENTS IN VARCHAR2,
...
PROCEDURE FN_INSRT_KREN_NTFCTN_MSG_DELIV( AV_NTFCTN_ID IN NUMBER,
