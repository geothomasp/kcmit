select ' Start time of AWARD_SPECIAL_REVIEW script is '|| localtimestamp from dual
/
DECLARE
...
select ' End time of AWARD_SPECIAL_REVIEW script is '|| localtimestamp from dual
/