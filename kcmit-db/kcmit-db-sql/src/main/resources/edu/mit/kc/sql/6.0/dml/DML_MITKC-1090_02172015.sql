...
select count(prncpl_id) into li_count from krim_prncpl_t where prncpl_nm = 'kc-notificaion';
...
if li_count = 0 then
    ...
    begin
      ...
      VALUES(li_seq_fdoc_nbr,li_seq_entity_id,SYS_GUID(),li_ver_nbr,li_seq_prncpl_id,'kc-notificaion',NULL,NULL,ls_actv_ind);

      INSERT INTO KRIM_PRNCPL_T(PRNCPL_ID,OBJ_ID,VER_NBR,PRNCPL_NM,ENTITY_ID,PRNCPL_PSWD,ACTV_IND,LAST_UPDT_DT)
      VALUES(li_seq_prncpl_id,SYS_GUID(),li_ver_nbr,'kc-notificaion',li_seq_entity_id,NULL,ls_actv_ind,ll_last_upd_tmst);
	...
	BEGIN   
	  ...
	  VALUES(li_seq_entity_nm_id,SYS_GUID(),li_ver_nbr,li_seq_entity_id,'PRFR','notification',NULL,'kc',NULL,NULL,'Y',ls_actv_ind,ll_last_upd_tmst,NULL,NULL,NULL);
