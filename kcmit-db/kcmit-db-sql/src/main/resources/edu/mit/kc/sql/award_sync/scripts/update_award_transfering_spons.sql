select ' Start time of UPDATE_AWARD_TRANSFERRING_SPONSOR is '|| localtimestamp from dual
/
DECLARE
...
/
select ' End time of UPDATE_AWARD_TRANSFERRING_SPONSOR is '|| localtimestamp from dual
/