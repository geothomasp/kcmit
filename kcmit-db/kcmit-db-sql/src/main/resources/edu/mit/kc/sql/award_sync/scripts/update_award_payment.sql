select ' Start time of UPDATE_AWARD_PAYMENT_SCHEDULE is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of UPDATE_AWARD_PAYMENT_SCHEDULE is '|| localtimestamp from dual
/