 ...
 ------------ I N S E R T 
    if li_count_bud_doc = 0 then 
		...
		BEGIN
			...
			INSERT INTO EPS_PROPOSAL_BUDGET_EXT(BUDGET_ID,FINAL_VERSION_FLAG,VER_NBR,UPDATE_TIMESTAMP,UPDATE_USER,DOCUMENT_NUMBER,OBJ_ID)
			VALUES(li_seq_budget_id,r_budget.FINAL_VERSION_FLAG,li_ver_nbr,r_budget.UPDATE_TIMESTAMP,r_budget.UPDATE_USER,ls_doc_nbr,SYS_GUID());
