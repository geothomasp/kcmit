...
Insert into TMP_ROLE_PERM_MAPPING (ROLE_NM,ROLE_NMSPC_CD,ROLE_KIM_TYP_NM,PERM_NM,PERM_NMSPC_CD) values ('View Subcontract','KC-ADM','UnitHierarchy','VIEW SUBAWARD','KC-SUBAWARD');
Insert into TMP_ROLE_PERM_MAPPING (ROLE_NM,ROLE_NMSPC_CD,ROLE_KIM_TYP_NM,PERM_NM,PERM_NMSPC_CD) values ('View Subcontract','KC-ADM','UnitHierarchy','View Subaward Invoice','KC-SUBAWARD');
