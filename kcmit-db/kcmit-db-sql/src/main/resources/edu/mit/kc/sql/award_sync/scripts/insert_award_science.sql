select ' Start time of AWARD_SCIENCE_KEYWORD script is '|| localtimestamp from dual
/
DECLARE
...
END;
/	
select ' End time of AWARD_SCIENCE_KEYWORD script is '|| localtimestamp from dual
/