...
LEFT OUTER JOIN OSP$AWARD_SCIENCE_CODE@coeus.kuali ac ON t.MIT_AWARD_NUMBER=ac.MIT_AWARD_NUMBER and t.SEQUENCE_NUMBER=ac.SEQUENCE_NUMBER
WHERE t.FEED_TYPE='N'
...
EXIT WHEN c_award_comment%NOTFOUND;
    ...
    IF r_award_comment.MIT_AWARD_NUMBER IS NULL THEN
	   ...
	   IF ls_award_number is null THEN
            ...
            WHERE AWARD_ID=(SELECT MAX(aw.AWARD_ID) FROM AWARD_SCIENCE_KEYWORD aw WHERE aw.AWARD_ID<r_award_comment.AWARD_ID);
