...
SELECT MIT_AWARD_NUMBER,SEQUENCE_NUMBER,DOCUMENT_ID,DOCUMENT_TYPE_CODE,DESCRIPTION,FILE_NAME,DOCUMENT,DOCUMENT_STATUS_CODE,UPDATE_TIMESTAMP,UPDATE_USER,MIME_TYPE FROM OSP$AWARD_DOCUMENTS@coeus.kuali;
commit
/
