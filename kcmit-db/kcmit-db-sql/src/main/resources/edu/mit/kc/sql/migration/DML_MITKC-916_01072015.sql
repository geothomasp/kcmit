...
/
create table temp_eps_prop_mapping(
PROPOSAL_NUMBER     VARCHAR2(12),
NEW_PROPOSAL_NUMBER  VARCHAR2(12)
)
/
INSERT INTO temp_eps_prop_mapping(PROPOSAL_NUMBER,NEW_PROPOSAL_NUMBER)
...
CURSOR c_eps IS
SELECT PROPOSAL_NUMBER,NEW_PROPOSAL_NUMBER FROM TEMP_EPS_PROP_MAPPING;
r_eps c_eps%ROWTYPE;
