...
insert into KRMS_TERM_SPEC_T (TERM_SPEC_ID, NMSPC_CD, NM, DESC_TXT, TYP, ACTV, VER_NBR) 
	values (CONCAT('KCMIT', KRMS_FUNC_PARM_S.NEXTVAL),'KC-PD',(select FUNC_ID from KRMS_FUNC_T where  NM='hasNoticeOfOpportunity' and NMSPC_CD='KC-PD'),
			'Notice of opprtunity is missing','java.lang.Boolean','Y',1)
/
insert into KRMS_TERM_T (TERM_ID, TERM_SPEC_ID, VER_NBR, DESC_TXT) 
	values (CONCAT('KCMIT', KRMS_FUNC_PARM_S.NEXTVAL),(select TERM_SPEC_ID from KRMS_TERM_SPEC_T where NMSPC_CD='KC-PD' and  NM=(select FUNC_ID from KRMS_FUNC_T where  NM='hasNoticeOfOpportunity' and NMSPC_CD='KC-PD')),
...
insert into KRMS_TERM_RSLVR_T (TERM_RSLVR_ID, NMSPC_CD, NM, TYP_ID, OUTPUT_TERM_SPEC_ID, ACTV, VER_NBR) 
	values (CONCAT('KCMIT', KRMS_FUNC_PARM_S.NEXTVAL),'KC-PD','Notice Of Opportunity Check Resolver',
