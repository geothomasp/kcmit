select ' Started AWARD_SPECIAL_REVIEW Update ' from dual
/
...
inner join TEMP_TAB_TO_SYNC_AWARD ts on a.MIT_AWARD_NUMBER=ts.MIT_AWARD_NUMBER and a.SEQUENCE_NUMBER=ts.SEQUENCE_NUMBER
...
EXIT WHEN c_special%NOTFOUND;
	...
	and SPECIAL_REVIEW_CODE=r_special.SPECIAL_REVIEW_CODE;
...
commit;
/
select ' Ended AWARD_SPECIAL_REVIEW Update ' from dual
/