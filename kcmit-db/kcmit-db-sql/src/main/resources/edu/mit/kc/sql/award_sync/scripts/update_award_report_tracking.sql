select ' Start time of UPDATE_AWARD_REPORT_TRACKING is '|| localtimestamp from dual
/
DECLARE
...
a.lead_unit_number lead_unit_number,ac.REPORT_STATUS_CODE status_code,a.sponsor_code sponsor_code,a.sponsor_award_number sponsor_award_number,
...
END;
/	
select ' End time of UPDATE_AWARD_REPORT_TRACKING is '|| localtimestamp from dual
/