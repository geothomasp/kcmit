select ' Start time of BUDGET_DETAILS,BUDGET_DETAILS_CAL_AMTS,BUDGET_RATE_AND_BASE  script is '|| localtimestamp from dual
/
DECLARE
...
/
select ' End time of BUDGET_DETAILS,BUDGET_DETAILS_CAL_AMTS,BUDGET_RATE_AND_BASE  script is '|| localtimestamp from dual
/