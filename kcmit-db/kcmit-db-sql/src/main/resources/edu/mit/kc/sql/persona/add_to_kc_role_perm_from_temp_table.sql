...
cursor c_role is  
   select  distinct t1.ROLE_NM ,
	decode(t1.ROLE_NM,'Assistant Contract Administrator','KC-ADM',
	'Co-Investigator','KC-SYS',
	'Contract Administrator','KC-ADM',
	'Contract Specialist','KC-ADM',
	'DLC Approver','KC-ADM',
	'DLC Headquarters','KC-ADM',
	'DLC Proposal Development User','KC-ADM',
	'DLC User','KC-ADM',
	'Data Team Administrator','KC-ADM',
	'Dean Level Approver','KC-ADM',
	'Every User','KC-ADM',
	'IRB Administrator','KC-PROTOCOL',
	'Investigator','KC-ADM',
	'Key Person','KC-ADM',
	'Liason','KC-ADM',
	'NDA Administrator','KC-ADM',
	'OSP Administrative Assistant','KC-ADM',
	'Principal Investigator','KC-ADM',
	'Subaward Administrator','KC-ADM',
	'Support Team Administrator','KC-ADM',
	'Workload Balancing Administrator','KC-ADM') namespace
