...
/
INSERT INTO INSTITUTE_RATES(RATE_CLASS_CODE,RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID)
...
CURSOR c_inst IS
SELECT a.RATE_CLASS_CODE,a.RATE_TYPE_CODE,a.ACTIVITY_TYPE_CODE,a.FISCAL_YEAR,a.START_DATE,a.ON_OFF_CAMPUS_FLAG,a.UNIT_NUMBER,a.ACTIVE_FLAG,a.INSTITUTE_RATE FROM
(
SELECT '13' RATE_CLASS_CODE,'1' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'5' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'6' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'9' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'15' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'16' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=1 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'25' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=2 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'26' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=2 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'28' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=2 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'31' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=2 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'27' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=2 AND RATE_TYPE_CODE=1
UNION ALL
SELECT '13' RATE_CLASS_CODE,'10' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=4 AND RATE_TYPE_CODE IN(1,2,3)
UNION ALL
SELECT '13' RATE_CLASS_CODE,'17' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=4 AND RATE_TYPE_CODE IN(1,2,3)
UNION ALL
SELECT '13' RATE_CLASS_CODE,'24' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=4 AND RATE_TYPE_CODE IN(1,2,3)
UNION ALL
SELECT '13' RATE_CLASS_CODE,'13' RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE from INSTITUTE_RATES WHERE RATE_CLASS_CODE=4 AND RATE_TYPE_CODE IN(1,2,3)
) a;
...
BEGIN
INSERT INTO INSTITUTE_RATES(RATE_CLASS_CODE,RATE_TYPE_CODE,ACTIVITY_TYPE_CODE,FISCAL_YEAR,START_DATE,ON_OFF_CAMPUS_FLAG,UNIT_NUMBER,ACTIVE_FLAG,INSTITUTE_RATE,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID)
VALUES(r_inst.RATE_CLASS_CODE,r_inst.RATE_TYPE_CODE,r_inst.ACTIVITY_TYPE_CODE,r_inst.FISCAL_YEAR,r_inst.START_DATE,r_inst.ON_OFF_CAMPUS_FLAG,r_inst.UNIT_NUMBER,r_inst.ACTIVE_FLAG,r_inst.INSTITUTE_RATE,sysdate,'admin',1,sys_guid());
EXCEPTION
WHEN OTHERS THEN
continue;
END;
