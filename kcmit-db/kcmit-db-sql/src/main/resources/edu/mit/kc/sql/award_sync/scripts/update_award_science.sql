select ' Start time of UPDATE_AWARD_SCIENCE_KEYWORD is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of UPDATE_AWARD_SCIENCE_KEYWORD is '|| localtimestamp from dual
/