...
/
---------------------------
DELETE FROM KRMS_CMPND_PROP_PROPS_T WHERE PROP_ID in (  SELECT PROP_ID FROM KRMS_PROP_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_ACTN_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ) )
/
