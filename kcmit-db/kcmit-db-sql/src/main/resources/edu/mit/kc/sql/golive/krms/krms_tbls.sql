...
DECLARE
	...
	WHERE AGENDA_ID IN (SELECT AGENDA_ID FROM KRMS_AGENDA_ITM_T@KC_STAG_DB_LINK WHERE RULE_ID IN ( SELECT RULE_ID FROM KRMS_ACTN_T@KC_STAG_DB_LINK 
	WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t@KC_STAG_DB_LINK WHERE nm = 'Route to PeopleFlow') ))
	UNION
	SELECT AGENDA_ID FROM KRMS_AGENDA_T@KC_STAG_DB_LINK 
	WHERE AGENDA_ID IN (SELECT SUB_AGENDA_ID FROM KRMS_AGENDA_ITM_T@KC_STAG_DB_LINK WHERE RULE_ID IN ( SELECT RULE_ID FROM KRMS_ACTN_T@KC_STAG_DB_LINK 
	WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t@KC_STAG_DB_LINK WHERE nm = 'Route to PeopleFlow') ));
