...
/
---------------------------
DELETE FROM KRMS_CMPND_PROP_PROPS_T WHERE PROP_ID in (  SELECT PROP_ID FROM KRMS_PROP_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ) )
/
DELETE FROM KRMS_PROP_PARM_T WHERE PROP_ID in ( SELECT PROP_ID FROM KRMS_PROP_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ) )
/
DELETE FROM KRMS_PROP_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') )
/
DELETE FROM KRMS_RULE_ATTR_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') )
/
DELETE FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow')
/
...
DECLARE
	...
	WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') );
	r_data c_data%rowtype;
...
EXIT WHEN c_data%NOTFOUND;
	...
	SELECT KRMS_CMPND_PROP_PROPS_S.nextval,ls_seq FROM KRMS_CMPND_PROP_PROPS_T@KC_STAG_DB_LINK
	WHERE PROP_ID = r_data.PROP_ID;
...
END;
/
DELETE FROM KRMS_AGENDA_ATTR_T WHERE AGENDA_ID IN (SELECT AGENDA_ID FROM KRMS_AGENDA_ITM_T WHERE RULE_ID IN ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ))
/
DELETE FROM KRMS_AGENDA_T WHERE AGENDA_ID IN (SELECT AGENDA_ID FROM KRMS_AGENDA_ITM_T WHERE RULE_ID IN ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ))
/
DELETE FROM KRMS_AGENDA_ITM_T WHERE RULE_ID IN ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') )
/
DECLARE
	cursor c_data is
	select t2.agenda_id, t1.rule_id from KRMS_AGENDA_ITM_T t1 inner join KRMS_AGENDA_T t2 on t1.AGENDA_ID = t2.AGENDA_ID
	where t1.RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') );	
	r_data c_data%rowtype;	
...
/
DELETE FROM KRMS_ACTN_ATTR_T WHERE ACTN_ID in ( select actn_id from krms_actn_t where RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') ) )
/
DELETE FROM KRMS_ACTN_T WHERE RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') )
/
DECLARE
	cursor c_data is
	SELECT a.ACTN_ID,a.RULE_ID FROM KRMS_ACTN_T@KC_STAG_DB_LINK a
	WHERE a.RULE_ID in ( SELECT RULE_ID FROM KRMS_RULE_T WHERE typ_id IN ( SELECT typ_id FROM krms_typ_t WHERE nm = 'Route to PeopleFlow') );
	r_data c_data%rowtype;
