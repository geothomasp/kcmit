select ' Start time of UPDATE_AWARD_FUNDING_PROPOSALS is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of UPDATE_AWARD_FUNDING_PROPOSALS is '|| localtimestamp from dual
/