select ' Start time of UPDATE_AWARD_PERS_UNIT_CRED_SPLITS is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of UPDATE_AWARD_PERS_UNIT_CRED_SPLITS is '|| localtimestamp from dual
/