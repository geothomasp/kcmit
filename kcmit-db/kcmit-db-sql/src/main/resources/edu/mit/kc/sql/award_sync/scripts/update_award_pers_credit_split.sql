select ' Start time of UPDATE_AWARD_PERSON_CREDIT_SPLITS is '|| localtimestamp from dual
/
DECLARE
...
END;
/
select ' End time of UPDATE_AWARD_PERSON_CREDIT_SPLITS is '|| localtimestamp from dual
/