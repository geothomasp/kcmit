...
LEFT OUTER JOIN OSP$AWARD_PER_CREDIT_SPLIT@coeus.kuali ac ON t.MIT_AWARD_NUMBER=ac.MIT_AWARD_NUMBER and t.SEQUENCE_NUMBER=ac.SEQUENCE_NUMBER
WHERE t.FEED_TYPE='N'
...
END;
/	
select ' End time of AWARD_PERSON_CREDIT_SPLITS script is '|| localtimestamp from dual
/