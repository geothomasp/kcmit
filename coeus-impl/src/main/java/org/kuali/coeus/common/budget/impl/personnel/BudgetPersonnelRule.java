...
public class BudgetPersonnelRule {
    ...
    protected boolean isJobCodeChanged(BudgetPerson budgetPerson) {
    	...
    	boolean isJobCodeChanged = false;
    	if(originalBudgetPerson!=null && !originalBudgetPerson.getJobCode().equalsIgnoreCase(budgetPerson.getJobCode())){
    		isJobCodeChanged = true;   
    	}
    	return isJobCodeChanged;
    }
