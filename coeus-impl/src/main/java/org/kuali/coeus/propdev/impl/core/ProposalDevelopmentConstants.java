...
public class ProposalDevelopmentConstants {
    ...
    public static class PropDevParameterConstants {
		...
		public static final String S2S_SUBMISSION_TYPE_CODE_PREAPPLICATION_PARM = "S2S_SUBMISSION_TYPE_CODE_PREAPPLICATION";
	    ...
	    public static final String PROPOSAL_TYPE_CODE_SUPPLEMENT_PARM = "PROPOSAL_TYPE_CODE_SUPPLEMENT";
    }
