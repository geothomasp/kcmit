...
public class InstitutionalProposalServiceImpl implements InstitutionalProposalService {
    ...
    public String getNextInstitutionalProposalNumber() {  	    	
    	String generatedIPAsString="";
    	if(generateIPFiscalYearBased()){
    		generatedIPAsString = getNextIPFiscalYearBased();
    	}else{
      ...
      generatedIPAsString = formatter.format(nextProposalNumber);}
        return generatedIPAsString;
    }
    public String getNextIPFiscalYearBased() {
