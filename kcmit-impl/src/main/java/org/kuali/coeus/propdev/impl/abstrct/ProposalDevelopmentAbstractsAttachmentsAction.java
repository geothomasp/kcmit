...
import org.kuali.kra.proposaldevelopment.service.MitPropNarrativeService;
...
public class ProposalDevelopmentAbstractsAttachmentsAction extends ProposalDevelopmentAction {
    ...
    private static final String PROP_APPROVAL_PENDING_STATUS = "2";
    ...
    */
    ...
    public ActionForward replaceProposalAttachment(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if(pd.getDevelopmentProposal().getProposalStateTypeCode().equals(PROP_APPROVAL_PENDING_STATUS)){
            forward=KcServiceLocator.getService(MitPropNarrativeService.class).sendNotification(mapping, proposalDevelopmentForm, modifiedNarrative);}
