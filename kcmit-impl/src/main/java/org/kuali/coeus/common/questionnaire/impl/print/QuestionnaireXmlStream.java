   ...
   /**
            ...
            if (moduleQuestionnaireBean != null && moduleQuestionnaireBean.getModuleItemCode() != null) {
                ...
                if (moduleCode.equals(CoeusModule.PROPOSAL_DEVELOPMENT_MODULE_CODE)  && "0".equals(moduleSubcode)) {
                    setDevProposalInfo((DevelopmentProposal) printableBusinessObject,questionnaireType);
                        ...
                        (KcMitConstants.PROPOSAL_PERSON_PI_CERTIFICATION.equals(moduleSubcode)
                        ||KcMitConstants.PROPOSAL_PERSON_KP_CERTIFICATION.equals(moduleSubcode)||
                        KcMitConstants.PROPOSAL_PERSON_COI_CERTIFICATION.equals(moduleSubcode))) {
    ...
    private ModuleQuestionnaireBean getQuestionnaireAnswerHeaderBean(
        ...
        if(printableBusinessObject instanceof Protocol){
            ...
            ProposalPerson person = (ProposalPerson) printableBusinessObject;
            moduleSubItemCode = getSubModuleItemCode(person.getProposalPersonRoleId());
        ...
        return getModuleSpecificBean(moduleItemCode,moduleItemKey,moduleSubItemCode,moduleSubItemKey, false);
    ...
    private  String getSubModuleItemCode(String roleId){
    ...
    private ModuleQuestionnaireBean getModuleSpecificBean(String moduleItemCode, String moduleItemKey, String moduleSubItemCode, String moduleSubItemKey, boolean finalDoc) {
