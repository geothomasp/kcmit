...
public class AwardReportAuditRule implements DocumentAuditRule {
    ...
    public static final String ENABLE_FREQUENCYBASE_VALIDATION_FORNULL_PARAM = "EnableFrequencyBaseValidationForNull";
    public static final String ENABLE_FREQUENCY_VALIDATION_FORNULL_PARAM = "EnableFrequencyValidationForNull";
	...
	protected boolean isValidFrequencyBase(AwardReportTerm awardReportTerm,
			List<KeyValue> frequencyBaseCodes) {
		boolean isValid = false;
		String enableValidation = parameterService.getParameterValueAsString(
	...
	protected boolean isValidFrequency(AwardReportTerm awardReportTerm,
