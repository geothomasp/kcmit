				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						...
						<xsl:for-each select="$XML">
										...
										<fo:table-body font-family="Arial" start-indent="0pt">
											<fo:table-row>
												<fo:table-cell font-family="Arial" number-columns-spanned="2" padding="2pt" height="2" display-align="after">
													...
													<fo:block/>
													<fo:inline>
													  <xsl:text>Descriptions of the hold notifications can be found </xsl:text>
													</fo:inline>
													<fo:basic-link text-decoration="underline" color="blue">
															<xsl:choose>
															<xsl:when test="substring(string(&apos;http://osp.mit.edu/grant-and-contract-administration/setting-up-an-award/coi-and-special-review-hold-notice-definitions &apos;), 1, 1) = '#'">
																	<xsl:attribute name="internal-destination">
																		<xsl:value-of select="substring(string(&apos;http://osp.mit.edu/grant-and-contract-administration/setting-up-an-award/coi-and-special-review-hold-notice-definitions &apos;), 2)"/>
																	</xsl:attribute>
																</xsl:when>
																<xsl:otherwise>
																       ...
																       <xsl:text>url(</xsl:text>
																		<xsl:call-template name="double-backslash">
																			<xsl:with-param name="text">
																				<xsl:value-of select="string(&apos;http://osp.mit.edu/grant-and-contract-administration/setting-up-an-award/coi-and-special-review-hold-notice-definitions &apos;)"/>
																			</xsl:with-param>
																			<xsl:with-param name="text-length">
																				<xsl:value-of select="string-length(string(&apos;http://osp.mit.edu/grant-and-contract-administration/setting-up-an-award/coi-and-special-review-hold-notice-definitions &apos;))"/>
																			</xsl:with-param>
																		</xsl:call-template>
																		<xsl:text>)</xsl:text>
																	</xsl:attribute>
							...
							<xsl:if test="AwardNotice/Award/AwardKeyPersons/KeyPerson">
								<fo:table font-family="Arial" font-size="9pt" table-layout="fixed" width="100%" border-spacing="2pt">
									...
									<fo:table-body start-indent="0pt">
										<xsl:for-each select="AwardNotice">
											<xsl:for-each select="Award">
												<xsl:for-each select="AwardKeyPersons">
											...
											<fo:table-row>
												<fo:table-cell font-family="Arial" line-height="13pt" padding="6pt" number-columns-spanned="4" border="solid 1pt gray" display-align="center">
													<fo:block>
														...
														<fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
															<xsl:text>, NE18-901. Any attachments may be kept for your records.</xsl:text>
														</fo:inline>
														<fo:inline-container>
															<fo:block>
																<xsl:text>&#x2029;</xsl:text>
																	...
																	<fo:table-body start-indent="0pt">
																		...
																		<fo:table-row>
																			<fo:table-cell font-family="Arial" font-size="9pt" font-weight="bold" padding-bottom="1pt" padding="0pt" display-align="center">
																				<fo:block>
																					<fo:block/>
																					<xsl:if test="DueDate != &apos;1900-01-01Z&apos;">
																						<fo:inline>
