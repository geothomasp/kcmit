...
import edu.mit.kc.infrastructure.lifecycle.MitKcUnitTestMainLifecycle;
 ...
 */
@RunWith(MitKcUnitTestRunner.class)
public class MitKcUnitTestBase extends Assert implements MitKcUnitTestMethodAware {
    // non static Log to allow it to be named after the runtime class
    protected final Log LOG = LogFactory.getLog(this.getClass());

    private static MitKcUnitTestMainLifecycle LIFECYCLE = new MitKcUnitTestMainLifecycle();
    private static RunListener RUN_LISTENER = new MitKcUnitTestRunListener(LIFECYCLE);
