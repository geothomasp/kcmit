...
import edu.mit.kc.infrastructure.lifecycle.MitKcUnitTestLifecycle;
 ...
 */
public class MitKcUnitTestRunListener extends RunListener {
    protected final Log LOG = LogFactory.getLog(this.getClass());
    
    MitKcUnitTestLifecycle lifecycle;
    List<Failure> assumptionFailures = new ArrayList<Failure>();
    List<Failure> failures = new ArrayList<Failure>();
    List<Description> ignoredTests = new ArrayList<Description>();
    
    public MitKcUnitTestRunListener (MitKcUnitTestLifecycle lifecycle) {
